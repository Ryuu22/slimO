            ...
            BeginDrawing();
                ...
                switch(currentScreen) 
                {
                    ...
                    { 
                        ...
                        DrawTextEx(fontforHUD,FormatText("%i", trailcoolDown/60 ), (Vector2){120,70},45,5,YELLOW);  //Trail CoolDown
                        DrawTextEx(fontforHUD,FormatText("%i", towerCD/60 ), (Vector2){210,70},45,5,YELLOW);        //Tower CoolDown
                        DrawTextEx(fontforHUD,FormatText("Gold: %i", playerGold ), (Vector2){900,70},35,5,YELLOW);  //Gold
                        DrawTextEx(fontforHUD,FormatText("Score: %i", deadSlimesCounter ), (Vector2){1100,70},35,5,YELLOW);  //Score
                        ...
                        if(skillMenu)
                        {
                            DisplayMenu(screenHeight,screenWidth,trailIcon,unLockTrail,mousePosition,unLockTexture,playerGold,trailUpgrade,trailUpgrade2,sawIcon,unLockSaw,sawUpgrade,sawUpgrade2,buildingIcon);
                        }
